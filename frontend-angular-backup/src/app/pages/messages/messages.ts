...
export class Messages implements OnInit, OnDestroy, AfterViewChecked {
  ...
  ngOnInit(): void {
    ...
    // Busca mensagens e inscreve-se no canal de realtime
    this.route.paramMap.pipe(
      switchMap(params => {
        ...
        // Inscreve-se no canal de realtime para mensagens desta conversa
        this.messageService.subscribeToConversation(conversationId).subscribe(newMessage => {
